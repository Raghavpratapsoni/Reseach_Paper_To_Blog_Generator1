...
# 🔐 HARDCODED API TOKENS (DO NOT SHARE THESE PUBLICLY)
HUGGINGFACE_TOKEN = "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"  # Replace with your actual token
GROQ_API_KEY = "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"  # Replace with your actual token
